                ...
                <div class="col-md-2 pr-3 pt-4 menu-samping position-fixed">
                    <ul class="nav flex-column ml-3 mb-5">
                        ...
                        <li class="nav-item mt-5">
                            <a class="nav-link link-menu mb-2" href="admin_dashboard.php"><i class="fas fa-home mr-2"></i>Dasboard</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link link-menu" href="admin_user.php"><i class="fas fa-user mr-2"></i>Data User</a>
                        </li>
                        <li class="nav-item">
